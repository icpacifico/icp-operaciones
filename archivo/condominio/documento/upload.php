...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true) {
        $this->options = array(
            ...
            'upload_dir' => dirname($_SERVER['SCRIPT_FILENAME']).'/'.$_SESSION["codigo_condominio_panel"].'/',
            'upload_url' => $this->get_full_url().'/'.$_SESSION["codigo_condominio_panel"].'/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
    ...
    public function post($print_response = true) {
        ...
        if ($upload && is_array($upload['tmp_name'])) {
            ...
            foreach ($upload['tmp_name'] as $index => $value) {
				...
				$consulta = "INSERT INTO condominio_documento_condominio VALUES(0,'".$_SESSION["codigo_condominio_panel"]."','".$upload['name'][$index]."')";
    ...
    public function delete($print_response = true) {
		...
		$conexion = new conexion();
        $file_name = $this->get_file_name_param();
        $consulta = "DELETE FROM condominio_documento_condominio WHERE nombre_doc_con = '".$file_name."' AND id_con = '".$_SESSION["codigo_condominio_panel"]."'";
		$conexion->consulta($consulta);
        $file_path = $this->get_upload_path($file_name);
