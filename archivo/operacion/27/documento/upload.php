...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true) {
        $this->options = array(
            ...
            'upload_dir' => dirname($_SERVER['SCRIPT_FILENAME']).'/'.$_SESSION["codigo_venta_etapa_panel"].'/',
            'upload_url' => $this->get_full_url().'/'.$_SESSION["codigo_venta_etapa_panel"].'/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
    ...
    public function post($print_response = true) {
        ...
        if ($upload && is_array($upload['tmp_name'])) {
            ...
            foreach ($upload['tmp_name'] as $index => $value) {
				...
				$consulta = "INSERT INTO venta_etapa_documento_venta VALUES(0,'".$_SESSION["codigo_venta_etapa_panel"]."','".$upload['name'][$index]."')";
