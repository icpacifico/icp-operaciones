...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true) {
        $this->options = array(
            ...
            'upload_dir' => dirname($_SERVER['SCRIPT_FILENAME']).'/'.$_SESSION["codigo_propietario_panel"].'/',
            'upload_url' => $this->get_full_url().'/'.$_SESSION["codigo_propietario_panel"].'/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
    ...
    public function post($print_response = true) {
        ...
        if ($upload && is_array($upload['tmp_name'])) {
            ...
            foreach ($upload['tmp_name'] as $index => $value) {
				...
				$consulta = "INSERT INTO documento_propietario_documento VALUES(0,'".$_SESSION["codigo_propietario_panel"]."','".$upload['name'][$index]."')";
    ...
    public function delete($print_response = true) {
		...
		$conexion = new conexion();
        $file_name = $this->get_file_name_param();
        $consulta = "DELETE FROM documento_propietario_documento WHERE nombre_doc_pro = '".$file_name."' AND id_pro = '".$_SESSION["codigo_propietario_panel"]."'";
		$conexion->consulta($consulta);
        $file_path = $this->get_upload_path($file_name);
