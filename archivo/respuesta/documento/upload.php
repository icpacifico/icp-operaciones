...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true) {
        $this->options = array(
            ...
            'upload_dir' => dirname($_SERVER['SCRIPT_FILENAME']).'/'.$_SESSION["codigo_respuesta_panel"].'/',
            'upload_url' => $this->get_full_url().'/'.$_SESSION["codigo_respuesta_panel"].'/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
    ...
    public function post($print_response = true) {
        ...
        if ($upload && is_array($upload['tmp_name'])) {
            ...
            foreach ($upload['tmp_name'] as $index => $value) {
				...
				$consulta = "UPDATE ticket_respuesta_ticket SET documento_res_tic = '".$upload['name'][$index]."' WHERE id_res_tic = '".$_SESSION["codigo_respuesta_panel"]."'";
				$_SESSION["documento_respuesta_panel"] = $upload['name'][$index];
