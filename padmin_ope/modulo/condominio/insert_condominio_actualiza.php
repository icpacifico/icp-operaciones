...
$aCadena = file($destino);
    ...
    // 		}
	   ...
	   //  		}
				...
				$consulta = "UPDATE vivienda_vivienda SET id_mod = ?, valor_viv = ?, metro_viv = ?, metro_terraza_viv = ?, metro_total_viv = ? WHERE nombre_viv = ? AND id_pis = ? AND id_tor = ? ";
				$conexion->consulta_form($consulta,array($id_mod,$valor,$metro,$metro_terraza,$metro_total,$vivienda,$piso,$id_tor));
				//CUANDO EXISTE BODEGA
