...
?>
<title>Estacionamientos - Listado</title>
<!-- DataTables -->
                    ...
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            ...
                            if($cantidad_opcion > 0){
                                ?>
                                <li><a href="condominio_departamento_listado.php">DEPARTAMENTOS</a></li>
                                <?php
                            }
                            $consulta = 
                                "
                            ...
                            if($cantidad_opcion > 0){
                                ?>
                                <li class="active"><a href="condominio_estacionamiento_listado.php">ESTACIONAMIENTOS</a></li>
                                <?php
                            }
                            $consulta = 
                                "
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-2 radiomio">
                                                        <div class="radio bg-grays" style="margin-top: 20px; padding: 5px">
                                                            ...
                                                            <?php  
                                                            $consulta = "SELECT * FROM estacionamiento_estado_estacionamiento ORDER BY id_est_esta";
                                                            $conexion->consulta($consulta);
                                                            $fila_consulta = $conexion->extraer_registro();
                                                            if(is_array($fila_consulta)){
                                                                foreach ($fila_consulta as $fila) {
                                                                    ?>
                                                                    <input id="<?php echo utf8_encode($fila['nombre_est_esta']);?>" type="radio" name="filtro_estado" class="filtro_estado" value="<?php echo $fila['id_est_esta'];?>">
                                                                    <label for="<?php echo utf8_encode($fila['nombre_est_esta']);?>"><?php echo utf8_encode($fila['nombre_est_esta']);?></label>
                                                ...
                                                <h6 class="pull-right" style="font-style: italic; color:#ccc; font-size: 13px">
                                                  <i>Filtro: 
                                                    ...
                                                    if(isset($_SESSION["sesion_filtro_estado_panel"])){
                                                        $consulta = "SELECT * FROM estacionamiento_estado_estacionamiento WHERE id_est_esta = ?";
                                                        ...
                                                        if(is_array($fila_consulta_modelo)){
                                                            foreach ($fila_consulta_modelo as $fila) {
                                                                $texto_filtro = $fila['nombre_est_esta'];
                                                        ...
                                                        <?php
                                                        $filtro_consulta .= " AND est_esta.id_est_esta = ".$_SESSION["sesion_filtro_estado_panel"];
                                                    }
                                                    else{
                                                        ?>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                $consulta = 
                                                                    ...
                                                                    SELECT 
                                                                        ...
                                                                        est_esta.id_est_esta,
                                                                        est_esta.nombre_est_esta

                                                                    FROM 
                                                                        estacionamiento_estacionamiento AS esta
                                                                        INNER JOIN estacionamiento_estado_estacionamiento AS est_esta ON est_esta.id_est_esta = esta.id_est_esta
                                                                        LEFT JOIN vivienda_vivienda AS viv ON viv.id_viv = esta.id_viv
                                                                        INNER JOIN modelo_modelo AS mode ON mode.id_mod = viv.id_mod
                                                                        INNER JOIN torre_torre AS tor ON tor.id_tor = viv.id_tor
                                                                        INNER JOIN condominio_condominio AS con ON con.id_con = esta.id_con
                                                                ...
                                                                if(is_array($fila_consulta)){
                                                                    foreach ($fila_consulta as $fila) {
                                                                        $acumulado_monto = $acumulado_monto + $fila['valor_esta'];
                                                                        ?>
                                                                        <tr>
                                                                            ...
                                                                            <td><?php echo number_format($fila['valor_esta'], 0, ',', '.');?></td>
                                                                        </tr>
                                                                        <?php
                                                                    }
                                                                }
