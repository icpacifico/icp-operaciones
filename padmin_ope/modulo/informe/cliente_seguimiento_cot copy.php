                ...
                <div class="col-md-12">
                    ...
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            ...
                            if($cantidad_opcion > 0){
                                ?>
                                <li class="active"><a href="cliente_seguimiento_cot.php">CLIENTES SIN SEG.</a></li>
                                <?php
                            }
                            ...
                            if($cantidad_opcion > 0){
                                ?>
                                <li class=""><a href="cliente_seguimiento_cot_atrasados.php">CLIENTES SEG./OBS Atrasado</a></li>
                                <?php
                            }
                                ...
                                <div class="tab-pane active" id="tab_1">
                                    <div class="box-body" style="padding-top: 0">
                                        <div class="row">
                                            ...
                                            <?php 
                                            if (!isset($_SESSION["sesion_contador_sin"])) {
												...
												if(is_array($fila_consulta_sin)){
												    foreach ($fila_consulta_sin as $fila_sin) {
												        ...
												        if ($tiene_obs == 0) {
												        	# code...revisa si tiene seguimientos sus cots
												        	$consulta_cot_seg = "
													        	SELECT 
													                seg.id_seg_cot
													            FROM
													        ...
													        if ($tiene_seg == 0) {
													        	array_push($array_id_pro, $id_pro);
													        	$contador_sin_nada ++;
													        }
												        }
												    }
												...
												$contador_sin_nada = $_SESSION["sesion_contador_sin"];
												$ids_pro = $_SESSION["sesion_ids_pro_sin"];
											}

											// print_r($array_id_pro);
                                             ?>
                                            ...
                                            <div class="row" id="contenedor_tabla">
                                                <div class="box">
                                                    <div class="box-header">
                                                        <h3 class="box-title">CLIENTES SIN SEGUIMIENTO (OBS / SEG.)</h3>
                                                    </div>
                                                    <!-- /.box-header -->
                                                    <div class="box-body no-padding table-responsive">
                                                    	<div style="font-size: 2.5rem; font-weight: bold; padding-left: 20px">Cantidad: <?php echo $contador_sin_nada; ?></div>
                                                        ...
                                                        <table id="example" class="table table-bordered" cellspacing="0" width="100%">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                if (!isset($_SESSION["sesion_ids_pro_sin"])) {
                                                                	$ids_pro = join(',',$array_id_pro);
                                                                }
                                                                
                                                                // echo $ids_pro;
                                                                $_SESSION["sesion_ids_pro_sin"] = $ids_pro;
                                                                $_SESSION["sesion_contador_sin"] = $contador_sin_nada;
