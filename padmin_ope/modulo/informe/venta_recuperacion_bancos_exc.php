...
$nombre = 'Recuperacion_Bancos_'.date('d-m-Y');
                                        ...
                                        if(isset($id_con)){  
											...
											<div class="col-md-12">
												...
												<table class="table table-bordered">
                                                    ...
                                                    // $consulta = "SELECT id_ban, nombre_ban FROM banco_banco WHERE id_ban = 10 ORDER BY nombre_ban";
                                                    $conexion->consulta($consulta);
                                                    ...
                                                    // $total_contados_por_recibir = $acumula_total_inmob - $acumula_pie_pagados;
												...
												<?php 
												// SOLO  CUANDO ES CONTADO O CREDITOS
												if($sin_tabla == 0) {
												?>
													<br>
													<br>
																...
																<table style="width: 100%">
	                                                                ...
	                                                                if(is_array($fila_consulta)){
	                                                                    foreach ($fila_consulta as $fila) {
																			...
																			?>
																			<tr>
																				<td><?php echo number_format($credito_hipo, 2, ',', '.'); ?></td>
																			</tr>
																			<?php
																		}
																	}
