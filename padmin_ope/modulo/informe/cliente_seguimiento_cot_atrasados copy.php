                                        ...
                                        <div class="row">
                                            ...
                                            if (!isset($_SESSION["sesion_ids_pro"])) {
												...
												$consulta_clientes_sin_seg = 
												    ...
												    WHERE 
												    	(cot.id_est_cot = 1 or cot.id_est_cot = 4)
												    ";
												...
												if(is_array($fila_consulta_sin)){
												    foreach ($fila_consulta_sin as $fila_sin) {
												        ...
												        if ($tiene_obs>0) {
															...
															if(is_array($fila_consulta_obs)){
															    foreach ($fila_consulta_obs as $fila_obs) {
															        ...
															        // echo $fecha_ultimo_obs."<---última obs---";
															        $fecha_limite = date("Y-m-d", strtotime("$hoy - $tolerancia days"));
															        if($fecha_ultimo_obs < $fecha_limite){
															        	$atraso_obs = 1;
															        } else {
															        	$atraso_obs = 0;
															        }
												        ...
												        if ($tiene_seg>0) {
															...
															if(is_array($fila_consulta_seg)){
															    foreach ($fila_consulta_seg as $fila_seg) {
															        ...
															        // echo $fecha_ultimo_seg;
															        $fecha_limite = date("Y-m-d", strtotime("$hoy - $tolerancia days"));
															        if($fecha_ultimo_seg < $fecha_limite){
															      		$atraso_seg = 1;
															        } else {
															        	$atraso_seg = 0;
															        }
														...
														if ($atraso_obs==1 && $atraso_seg==1) {
															array_push($array_id_pro, $id_pro);
														}
												    }
												}
											} else {
												// $contador_atrasos = $_SESSION["sesion_contador_sin_atraso"];
                                            ...
                                            <div class="row" id="contenedor_tabla">
                                                <div class="box">
                                                    <div class="box-header">
                                                        <h3 class="box-title">CLIENTES CON SEGUIMIENTO ATRASADO (<?php echo $tolerancia;?> días) (OBS / SEG.)</h3>
                                                    </div>
                                                    <!-- /.box-header -->
                                                    <div style="font-size: 2.5rem; font-weight: bold; padding-left: 20px">Cantidad: <?php echo count($array_id_pro); ?></div>
                                                    <div class="box-body no-padding table-responsive">
                                                        ...
                                                        <table id="example" class="table table-bordered" cellspacing="0" width="100%">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                // echo $ids_pro;
                                                                $_SESSION["sesion_ids_pro"] = $ids_pro;
                                                                // $_SESSION["sesion_contador_sin_atraso"] = $contador_atrasos;
