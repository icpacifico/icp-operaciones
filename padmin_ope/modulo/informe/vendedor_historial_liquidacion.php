...
?>
<title>Liquidación - Informe</title>
<!-- DataTables -->
                    ...
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            ...
                            if($cantidad_opcion > 0){
                                ?>
                                <li><a href="vendedor_comision_listado.php">COMISIONES</a></li>
                                <?php
                            }*/
                            ...
                            if($cantidad_opcion > 0){
                                ?>
                                <li class="active"><a href="vendedor_historial_liquidacion.php">LIQUIDACIÓN</a></li>
                                <?php
                            }
                            ?>
                        </ul>
                                                ...
                                                <h6 class="pull-right" style="font-style: italic; color:#ccc; font-size: 13px">
                                                  <i>Filtro: 
                                                    ...
                                                    if(isset($_SESSION["sesion_filtro_vendedor_panel"])){
                                                        ...
                                                        <?php
                                                        $filtro_consulta .= " AND vend.id_vend = ".$_SESSION["sesion_filtro_vendedor_panel"];
                                                    }
                                                    else{
                                                        ?>
                                                                ...
                                                                if(is_array($fila_consulta)){
                                                                    foreach ($fila_consulta as $fila) {
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td><?php echo date("d/m/Y",strtotime($fila["fecha_desde_cie"])); ?></td>
                                                                            <td><?php echo date("d/m/Y",strtotime($fila["fecha_hasta_cie"])); ?></td>
    ...
    $(document).ready(function () {
        ...
        $(document).on( "click","#filtro" , function() {
            ...
            $.ajax({
                ...
                data:"vendedor="+var_vendedor+"&periodo="+var_periodo+"&condominio="+var_condominio,
