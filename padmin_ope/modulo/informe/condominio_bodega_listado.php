                ...
                <div class="col-md-12">
                    ...
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            ...
                            if($cantidad_opcion > 0){
                                ?>
                                <li class="active"><a href="condominio_bodega_listado.php">BODEGA</a></li>
                                <?php
                            }
                            // $consulta = 
                            //     "
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-2 radiomio">
                                                        <div class="radio bg-grays" style="margin-top: 20px; padding: 5px">
                                                            ...
                                                            <?php  
                                                            $consulta = "SELECT * FROM bodega_estado_bodega ORDER BY id_est_bod";
                                                            $conexion->consulta($consulta);
                                                            $fila_consulta = $conexion->extraer_registro();
                                                            if(is_array($fila_consulta)){
                                                                foreach ($fila_consulta as $fila) {
                                                                    ?>
                                                                    <input id="<?php echo utf8_encode($fila['nombre_est_bod']);?>" type="radio" name="filtro_estado" class="filtro_estado" value="<?php echo $fila['id_est_esta'];?>">
                                                                    <label for="<?php echo utf8_encode($fila['nombre_est_bod']);?>"><?php echo utf8_encode($fila['nombre_est_bod']);?></label>
                                                ...
                                                <h6 class="pull-right" style="font-style: italic; color:#ccc; font-size: 13px">
                                                  <i>Filtro: 
                                                    ...
                                                    if(isset($_SESSION["sesion_filtro_estado_panel"])){
                                                        $consulta = "SELECT * FROM bodega_estado_bodega WHERE id_est_bod = ?";
                                                        ...
                                                        if(is_array($fila_consulta_modelo)){
                                                            foreach ($fila_consulta_modelo as $fila) {
                                                                $texto_filtro = $fila['nombre_est_bod'];
                                                        ...
                                                        <?php
                                                        $filtro_consulta .= " AND est_bod.id_est_bod = ".$_SESSION["sesion_filtro_estado_panel"];
                                                    }
                                                    else{
                                                        ?>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                $consulta = 
                                                                    ...
                                                                    FROM 
                                                                        ...
                                                                        LEFT JOIN vivienda_vivienda AS viv ON viv.id_viv = bod.id_viv
                                                                ...
                                                                if(is_array($fila_consulta)){
                                                                    foreach ($fila_consulta as $fila) {
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td><?php echo number_format($fila['valor_bod'], 0, ',', '.');?></td>
                                                                        </tr>
                                                                        <?php
                                                                    }
                                                                }
