...
#contenedor_propietario .form-group{
	margin-bottom: 10px;
}

#contenedor_propietario .form-group label{
	margin-bottom: 0;
}

#contenedor_propietario .form-control{
	padding:  2px 5px;
	height: 22px;
	line-height: 1rem;
}

#contenedor_propietario .select2-selection--single{
	height:  22px;
}

#contenedor_propietario .select2-selection--single .select2-selection__rendered{
	line-height: 1rem;
	margin-top: 0;
}
...
<div class="col-sm-12" style="margin-top: 10px;">
	<div class="box box-primary">
        ...
        <div class="box-body no-padding">
        	<form id="formulario" role="form" method="post" action="../cotizacion/update.php">
	        <?php  
	        $consulta = 
	            "
	            SELECT
	            ...
	            FROM
	                ...
	                LEFT JOIN region_region AS reg ON reg.id_reg = pro.id_reg
	        ...
	        <input type="hidden" name="no-edita-pro" id="no-edita-pro" value="1"></input>
	        <div class="box-body">
	            <div class="row">	                
	                <div class="col-sm-12" id="contenedor_propietario">
	                    ...
	                    <div class="col-md-2">
	                        <div class="form-group">
	                            ...
	                            <input type="text" name="nombre" class="form-control" id="nombre" value="<?php echo $nombre_pro;?>" disabled/>
	                        </div>
	                    </div>
	                    <div class="col-md-2">
	                        <div class="form-group">
	                            <label for="segundo_nombre">Segundo Nombre:</label>
	                            <input type="text" name="segundo_nombre" class="form-control" id="segundo_nombre" value="<?php echo $nombre2_pro;?>" disabled/>
	                        </div>
	                    ...
	                    <div class="col-md-2">
	                        <div class="form-group">
	                            ...
	                            <input type="text" name="apellido_paterno" class="form-control" id="apellido_paterno" value="<?php echo $apellido_paterno_pro;?>" disabled/>
	                        </div>
	                    </div>
	                    <div class="col-md-2">
	                        <div class="form-group">
	                            <label for="apellido_materno">Apellido Materno:</label>
	                            <input type="text" name="apellido_materno" class="form-control" id="apellido_materno" value="<?php echo $apellido_materno_pro;?>" disabled/>
	                        </div>
	                    </div>
	                    <div class="col-md-2">
	                        <div class="form-group">
	                            <label for="fono">Fono:</label>
	                            <input type="text" name="fono" class="form-control numero" id="fono" value="<?php echo $fono_pro;?>" disabled/>
	                        </div>
	                    </div>
	                    <div class="col-md-3">
	                        <div class="form-group">
	                            <label for="correo">Correo:</label>
	                            <input type="text" name="correo" class="form-control" id="correo" value="<?php echo $correo_pro;?>" disabled/>
	                        </div>
	                    ...
	                    <div class="col-md-2">
	                    	<div class="form-group">
	                            ...
	                            <select class="form-control select2" id="nacionalidad" name="nacionalidad" disabled> 
	                    ...
	                    <div class="col-sm-2">
	                    	<div class="form-group">
		                        ...
		                        <select class="form-control select2" id="comuna" name="comuna" disabled> 
	                    ...
	                    <div class="col-sm-2">
	                    	<div class="form-group">
	                            ...
	                            <select class="form-control select2" id="profesion" name="profesion" disabled> 
	                                <?php  
		                            if(!empty($id_prof)){
		                                ?>
	                    ...
	                    <div class="col-sm-3">
	                    	<div class="form-group">
	                            ...
	                            <input type="text" name="direccion_trabajo" class="form-control" id="direccion_trabajo" value="<?php echo $direccion_trabajo_pro;?>" disabled/>
	                        </div>
	                    </div>
	                    <div class="col-sm-3">
	                    	<div class="form-group">
