...
$nombre = 'recuperacion_final'.date('d-m-Y');
                                                            ...
                                                            if(is_array($fila_consulta)){
                                                                foreach ($fila_consulta as $fila) {
                                                                    ...
                                                                    $consulta = 
                                                                        ...
                                                                        WHERE
                                                                            id_ven = ? AND
                                                                            id_eta IN(".$n_etaco_alzamiento.",".$n_etacr_alzamiento.",".$n_etacr_soli_pago_ban.",".$n_etacr_liq_pagos.")
                                                                        ORDER BY 
                                                                            id_eta
                                                                        DESC
                                                                        ";
                                                                    ...
                                                                    $consulta = 
                                                                        ...
                                                                        WHERE
                                                                            id_ven = ? AND
                                                                            id_cam_eta IN(".$n_cam_etacr_fecha_sol_ch.",".$n_cam_etaco_valor_cre.",".$n_cam_etacr_valor_cre.",".$n_cam_etacr_fecha_sol_contab.",".$n_cam_etacr_fecha_cargo_301.",".$n_cam_etacr_fecha_abono_330.",".$n_cam_etaco_fecha_sol_oopp.",".$n_cam_etaco_fecha_sol_contab.",".$n_cam_etaco_fecha_cargo_301.",".$n_cam_etaco_fecha_abono_330.",".$n_cam_etacr_liq_pesos.",".$n_cam_etacr_liq_UF.",".$n_cam_etacr_liq_pesos_preinf.",".$n_cam_etacr_liq_UF_preinf.")
                                                                        ORDER BY 
                                                                            id_eta
                                                                        DESC
                                                                        ";
                                                                    ...
                                                                    if(is_array($fila_consulta_etapa)){
                                                                        foreach ($fila_consulta_etapa as $fila_etapa) {
                                                                            switch ($fila_etapa["id_cam_eta"]) {
                                                                                case $n_cam_etacr_fecha_sol_ch:
                                                                                    //------- FECHA SOLICITUD

                                                                                    break;
                                                                                case $n_cam_etaco_valor_cre:
                                                                                ...
                                                                                case $n_cam_etacr_valor_cre:
                                                                                    ...
                                                                                    break;
                                                                                case $n_cam_etacr_fecha_sol_contab:
                                                                                    ...
                                                                                    break;
                                                                                case $n_cam_etacr_fecha_cargo_301:
                                                                                    ...
                                                                                    break;
                                                                                case $n_cam_etacr_fecha_abono_330:
                                                                                    ...
                                                                                    break;
                                                                                case $n_cam_etaco_fecha_sol_oopp:
                                                                                    //------- FECHA SOLICITUD
                                                                                    break;
                                                                                case $n_cam_etaco_fecha_sol_contab:
                                                                                    ...
                                                                                    break;
                                                                                case $n_cam_etaco_fecha_cargo_301:
                                                                                    ...
                                                                                    break;
                                                                                case $n_cam_etaco_fecha_abono_330:
                                                                                    ...
                                                                                    break;
                                                                                case $n_cam_etacr_liq_pesos_preinf:
                                                                                    //------- FECHA ABONO ALZAMIENTO CREDITO
                                                                                    if(!empty($fila_etapa["valor_campo_eta_cam_ven"])){
                                                                                        $valor_liquidado_peso = $fila_etapa["valor_campo_eta_cam_ven"];
                                                                                    }
                                                                                    break;
                                                                                case $n_cam_etacr_liq_UF_preinf:
                                                                                    //------- FECHA ABONO ALZAMIENTO CREDITO
                                                                                    if(!empty($fila_etapa["valor_campo_eta_cam_ven"])){
                                                                                        $valor_liquidado_uf = $fila_etapa["valor_campo_eta_cam_ven"];
                                                                                    }
                                                                                    break;
                                                                                case $n_cam_etacr_liq_pesos:
                                                                                    //------- FECHA ABONO ALZAMIENTO CREDITO
                                                                                    if(!empty($fila_etapa["valor_campo_eta_cam_ven"])){
                                                                                        $valor_liquidado_peso = $fila_etapa["valor_campo_eta_cam_ven"];
                                                                                    }
                                                                                    break;
                                                                                case $n_cam_etacr_liq_UF:
                                                                                    //------- FECHA ABONO ALZAMIENTO CREDITO
                                                                                    if(!empty($fila_etapa["valor_campo_eta_cam_ven"])){
                                                                                        $valor_liquidado_uf = $fila_etapa["valor_campo_eta_cam_ven"];
                                                                                    }
