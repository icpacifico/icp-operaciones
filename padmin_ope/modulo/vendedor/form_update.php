...
<div class="box box-warning">
    ...
    <form id="formulario" role="form" method="post" action="update.php">
        <?php  
        $consulta = "SELECT * FROM vendedor_vendedor WHERE id_vend = ?";
        ...
        $rut_vend = utf8_encode($fila['rut_vend']);
        $correo_vend = utf8_encode($fila['correo_vend']);
        $fono_vend = utf8_encode($fila['fono_vend']);
                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="categoria" name="categoria" > 
                            ...
                            <?php  
                            $consulta = "SELECT * FROM vendedor_categoria_vendedor WHERE id_cat_vend <> '".$id_cat_vend."' ORDER BY nombre_cat_vend";
                    ...
                    <?php 
                     ...
                     ?>
                     <input type="hidden" name="categoria" id="categoria" value="<?php echo $id_cat_vend;?>"></input>
                     <?php 
                 	}
                	?>
                    <div class="form-group">
                        <label for="nombre">Nombre:</label>
                        <input type="text" name="nombre" class="form-control" id="nombre" value="<?php echo $nombre_vend;?>"/>
                    </div>
                    <div class="form-group">
                        <label for="nombre">Apellido Paterno:</label>
                        <input type="text" name="apellido1" class="form-control" id="apellido1" value="<?php echo $apellido_paterno_vend;?>"/>
                    </div>
                    <div class="form-group">
                        <label for="nombre">Apellido Materno:</label>
                        <input type="text" name="apellido2" class="form-control" id="apellido2" value="<?php echo $apellido_materno_vend;?>"/>
                    </div>
                    <div class="form-group">
                        <label for="rut">Rut:</label>
                        <input type="text" name="rut" class="form-control rut" id="rut" value="<?php echo $rut_vend;?>" disabled/>
                    </div>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="correo" class="form-control" id="correo" value="<?php echo $correo_vend;?>"/>
                    </div>
                    <div class="form-group">
                        <label for="fono">Fono:</label>
                        <input type="text" name="fono" class="form-control" id="fono" value="<?php echo $fono_vend;?>"/>
                    </div>
                    <?php 
                    $readonly = "readonly";
                    if ($_SESSION["sesion_perfil_panel"] == 1) {
                        ...
                        <ul class="list-unstyled list-inline margin-0">
                            ...
                            if(is_array($fila_consulta)){
                                foreach ($fila_consulta as $fila) {
                                    ...
                                    $id_con = $fila['id_con'];
                                    $consulta = "SELECT * FROM vendedor_condominio_vendedor WHERE id_vend = ? AND id_con = ?";
        ...
        <input type="hidden" name="id_usu" id="id_usu" value="<?php echo $id_usu;?>"></input>
