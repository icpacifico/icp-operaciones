...
<div class="box-body">
    <ul class="list-unstyled list-inline margin-0">
        <?php
        $consulta = "SELECT * FROM vendedor_vendedor ORDER BY nombre_vend, apellido_paterno_vend, apellido_materno_vend ASC";
        ...
        if(is_array($fila_consulta)){
            foreach ($fila_consulta as $fila) {
                ...
                $consulta = "SELECT * FROM vendedor_jefe_vendedor WHERE id_usu = ? AND id_vend = ?";
                ...
                if($cantidad > 0){
                	...
                	$consulta = "SELECT * FROM vendedor_jefe_vendedor WHERE id_vend = ?";
