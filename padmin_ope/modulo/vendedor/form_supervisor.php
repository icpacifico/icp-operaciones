        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Asignacion Supervisor de Ventas</li>
                </ol>
            </section>
            <!-- Main content -->
                    ...
                    <div class="col-sm-12">
                      <!-- general form elements -->
                        <div class="box box-primary">
                            ...
                            <!-- /.box-header -->
                            <!-- form start -->
                            <form id="formulario" method="POST" action="insert_supervisor.php" role="form">
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="supervisor">Supervisor de Ventas:</label>
                                                <select class="form-control" id="supervisor" name="supervisor"> 
                                                    <option value="">Seleccione Supervisor de Ventas</option>
                                                    <?php  
                                                    $consulta = "SELECT * FROM usuario_usuario WHERE id_est_usu = 1 AND id_per = 5 ORDER BY nombre_usu, apellido1_usu, apellido2_usu";
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#formulario").validate({
            ...
            messages: { 
                supervisor: {
                    required: "Seleccione Supervisor de ventas"
                }
            }
        });
        ...
        $('#supervisor').change(function(){
            var_supervisor = $('#supervisor').val();
            if(var_supervisor != null && var_supervisor != ''){
                $.ajax({
                    type: 'POST',
                    url: ("procesa_usuario.php"),
                    data:"id="+var_supervisor,
