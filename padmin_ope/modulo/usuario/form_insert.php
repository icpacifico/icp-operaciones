                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="perfil" name="perfil"> 
                                                    ...
                                                    if ($_SESSION["sesion_perfil_panel"]==2) {
                                                        $consulta = "SELECT * FROM usuario_perfil WHERE (id_per <> 1 AND id_per <> 2 AND id_per <> 4) ORDER BY nombre_per";
                                                    } else {
                                                        $consulta = "SELECT * FROM usuario_perfil WHERE (id_per <> 4) ORDER BY nombre_per";
                                                    }
                                                    ...
                                                    if(is_array($fila_consulta)){
                                                        foreach ($fila_consulta as $fila) {
                                                            ?>
                                                            <option value="<?php echo $fila['id_per'];?>"><?php echo utf8_encode($fila['nombre_per']);?></option>
                                                            <?php
                                                        }
                                                    }
                                                    ?>
