    ...
    <form id="formulario" role="form" method="post" action="update.php">
        ...
        $consulta = 
            ...
            FROM
                ...
                INNER JOIN bodega_estado_bodega AS est_esta ON est_esta.id_est_bod = bod.id_est_bod
            WHERE
                bod.id_bod = ?
            ";
        $conexion->consulta_form($consulta,array($id_bod));
        ...
        $valor_bod = utf8_encode($fila['valor_bod']);
        ...
        ?>
        <input type="hidden" name="id" id="id" value="<?php echo $id_bod;?>"></input>
        <div class="box-body">
            <div class="row">
                <div class="col-sm-6">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nombre" class="form-control" id="nombre" value="<?php echo $nombre_bod;?>"></input>
                    </div>
                    <div class="form-group">
                        <label for="valor">Valor Bodega:</label>
                        <input type="text" name="valor" class="form-control numero" id="valor" value="<?php echo $valor_bod;?>"/>
                    </div>
                </div>
                <div class="col-sm-6">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        function resultado(data) {
            ...
            if (data.envio == 2) {
                swal("Atención!", "Bodega ya ha sido ingresado", "warning");
