...
<div class="box box-warning">
    <div class="box-header with-border">
        <h3 class="box-title"><i class="fa fa-check" aria-hidden="true"></i> Pasar a Venta      </h3>
    ...
    <!-- /.box-header -->
    <!-- form start -->
    <form id="formulario" role="form" method="post" action="insert_venta.php">
        <?php  
        $consulta = 
            "
            SELECT
        ...
        <div class="box-body">
            ...
            <div id="contendor_boton" class="box-footer">
                <button type="submit" class="btn btn-primary pull-right">Pasar a Venta</button>
            </div>
        </div>
        <!-- /.box-body -->
    ...
    $(document).ready(function() {
       $('.datepicker').datepicker({
        ...
        function resultado(data) {
            ...
            if (data.envio == 2) {
                swal("Atención!", "Venta ya ha sido ingresada", "warning");
