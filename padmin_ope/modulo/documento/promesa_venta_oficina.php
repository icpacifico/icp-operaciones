...
<body>
	<a class="btn no-print" href="promesa_venta_pdf.php?id=<?php echo $id; ?>" target="_blank">PDF</a>
	<?php  
	    ...
	    <tr>
	    	<td>
	    		...
	    		<div style="text-align: justify; line-height: 20px">
	    			...
	    			<b><u>CUARTO:</u></b> El precio de la compraventa será la suma total de <?php echo number_format($monto_ven, 2, ',', '.');?> Unidades de Fomento, Iva incluido, que se pagarán de la siguiente forma: <b>A)</b> en este acto, con la  suma de
	    			<?php 
					...
					?>
					equivalente al día de hoy a  <b>10,00</b> Unidades de Fomento, que la promitente vendedora declara recibir plenamente conforme.<b>B)</b>
                    ...
                    $fila_consulta = $conexion->extraer_registro();
                    $cont_pag_pie = 0;
                    echo "<b>".number_format($total_pie_uf, 2, ',', '.')."</b> Unidades de Fomento que se pagarán según detalle siguiente, ";
                    if(is_array($fila_consulta)){
                        foreach ($fila_consulta as $fila) {
							$valor_uf_efectivo = 0;
							$abono_uf = 0;
					...
					?>
					<b>C)</b> El saldo restante, equivalente a <b><?php echo number_format($saldo_cred_cont, 2, ',', '.'); ?></b> Unidades de Fomento, se pagará al momento de celebrarse el contrato de Compraventa Prometido, suma que será pagada mediante Crédito Hipotecario o de Contado. Las sumas entregadas por el Promitente Comprador, referidas en los literales a), b) y c) de la presente cláusula, se imputarán al precio total, tomándose como criterio de la mencionada imputación, las sumas convertidas a Unidades de Fomento según valor de ésta al momento del COBRO EFECTIVO de los documentos entregados por el Promitente Comprador. Todos los pagos anticipados serán garantizados con póliza de Avla Seguros de Crédito Y Garantía S.A.
					...
					<b><u>DÉCIMO CUARTO: De la entrega material de la cosa que se promete vender.</u></b> La entrega material de la cosa prometida se hará a la Promitente Vendedora al momento de otorgarse la escritura de Compraventa Definitiva, en forma simbólica, en la forma prevista en el artículo seiscientos ochenta y cuatro número uno del Código Civil, permitiéndole la promitente vendedora a la promitente compradora, la aprehensión material de la cosa vendida. Asimismo, la Promitente Vendedora, comunica en este acto y mediante este instrumento a la Promitente Compradora que el departamento que se vende, se estima que estará terminado el <b>primer trimestre del año dos mil veintitrés</b>, debiendo estar a esa fecha los saldos de precio debidamente cancelados.
					<b><u>DÉCIMO QUINTO: De los Gastos.</u></b> Los gastos, impuestos e inscripciones originados por el otorgamiento tanto de esta Promesa de Compraventa, así como los que deriven del contrato de Compraventa Prometido, serán de cargo del Promitente Comprador.
