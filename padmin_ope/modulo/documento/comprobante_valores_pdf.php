...
<body>';
	...
	<table class="sin-borde">
	    ...
	    <tr>
	    	<td>
	    		<table style="width: 100%; margin-top: 10px; margin-bottom: 13px">
					<tr>
						<td style="font-size: 1.5rem; font-weight: bold; text-align: center;">Comprobante Recepción de Valores</td>
					</tr>
				</table>
	    		...
	    		<table class="table_cliente">
	    			<tr>
	    				...
	    				<td>'.$rut_pro.'</td>
	    				<td><b>NOMBRE</b></td>
	    				<td>'.mb_strtoupper(utf8_encode($nombre_pro." ".$nombre2_pro." ".$apellido_paterno_pro." ".$apellido_materno_pro)).'</td>
	    			</tr>
	    			<tr>
	    				<td><b>ACUERDO</b></td>
	    				<td>'.$cantidad_compras.'</td>
	    				<td><b>CONCEPT. COBRO</b></td>
	    				<td>'.mb_strtoupper($nombre_cat_pag).'</td>
	    			</tr>
	    			<tr>
	    				<td><b>FECHA MONEDA</b></td>
	    				<td>'.date("d/m/Y",strtotime($fecha_ven)).'</td>
	    			...
	    			<tr>
	    				...
	    				<td>'.strtoupper(utf8_encode($nombre_con)).'</td>
	    				<td></td>
	    				<td></td>
	    			</tr>
	    		</table>
		...
		<tr>
			<td>
				<table style="width: 100%; margin-top: 6px; margin-bottom: 13px">
					<tr>
						<td style="font-size: 1.5rem; font-weight: bold; text-align: center;">Documentos Recibidos</td>
					</tr>
				</table>
				<table style="width: 100%; border-collapse: collapse;" class="conborde centro">
                    ...
                    if(is_array($fila_consulta)){
						...
						<tr>
							...
							$html .= '</td>
							<td style="width: 20%">'.utf8_encode($fila["nombre_for_pag"]).'</td>
		...
		<tr>
			<td>
				<table style="width: 100%; margin-top: 6px; margin-bottom: 13px">
					<tr>
						<td style="font-size: 1.5rem; font-weight: bold; text-align: center;">Identificación de la Compra</td>
					</tr>
				</table>
				<table class="table_compra">
					...
					<tr>
						<td>'.$id_viv.'</td>
						<td>DEPARTAMENTO N° '.utf8_encode($nombre_viv).'</td>
						<td>';
							if($id_mod <> 3){
							 $html .= 'DEPT / '.$nombre_mod;
							} else {
								$html .= $nombre_mod;
							}
						$html .= '
						</td>
						<td>'.$metro_total_viv.'</td>
					</tr>';
			        ...
			        if(is_array($fila_consulta)){
			            ...
			            $html .= '
			            <tr>
			            	<td>'.$filaest['id_esta'].'E</td>
			            	<td>ESTACIONAMIENTO '.$filaest['nombre_esta'].'</td>
			            	<td>EST.</td>
			            	<td></td>
			            </tr>';
						}
			        ...
			        if(is_array($fila_consulta)){
			            ...
			            $html .= '
			            <tr>
			            	<td>'.$filaest['id_bod'].'B</td>
			            	<td>BODEGA '.$filaest['nombre_bod'].'</td>
			            	<td>BOD.</td>
			            	<td></td>
			            </tr>';
						}
					...
					$html .= '
					 <tr class="resumen">
					 	...
					 	<td><b>'.number_format($monto_ven, 2, ',', '.').' UF</b></td>
					 </tr>
				</table>
			</td>
		</tr>';
		...
		<tr>
			<td>
				<table class="table_firmas">
					...
					<tr class="firma">
						<td></td>
						<td>'.mb_strtoupper($nombre_vendedor).'</td>
						<td></td>
						<td></td>
					</tr>
				</table>
		...
		$html .= '
		<tr>
			<td style="text-align: center; font-weight: bold; padding-top: 20px">
...
$nombre = 'documentos/comprobante_pago_'.date('dmYHi').'.pdf';
