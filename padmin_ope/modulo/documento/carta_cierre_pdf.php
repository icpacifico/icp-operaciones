		...
		<tr>
			<td style="width: 50%; text-align: left; vertical-align: top">
				<table style="width: 70%; text-align: center;">
					<tr>
						<td class="borde-top">
							'.utf8_encode($nombre_pro." ".$nombre2_pro." ".$apellido_paterno_pro." ".$apellido_materno_pro).'<br>RUT: '.$rut_pro.'
						</td>
					</tr>
				</table>
			</td>
			<td style="text-align: right; vertical-align: top">
				<table style="width: 70%; text-align: center;">
					<tr>
						<td class="borde-top">
							'.$nombre_gerente_operacion.'<br>Gerente de Ventas y Operaciones<br>'.$nombre_empresa.'
						</td>
					</tr>
				</table>
			</td>
