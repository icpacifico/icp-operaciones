...
$nombre = 'carta_cierre_'.$id.'-'.date('d-m-Y');
	    ...
	    <tr>
			<td>
				<table style="width: 100%">
					<tr>
						<td>
							<img src="https://00ppsav.cl/padmin_ope/assets/img/logoicp.jpg" width="103" height="124">
						</td>
						<td style="text-align: right">
				            ...
				            if ($haylogo>0) {
				            	...
				            	?>
								<img src="https://00ppsav.cl/archivo/condominio/documento/<?php echo $id_con; ?>/<?php echo $nombre_doc_con; ?>" width="160" height="88">	
