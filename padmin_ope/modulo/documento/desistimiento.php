...
<body>
	<a href="desistimiento_pdf.php?id=<?php echo $id; ?>" class="no-print" style="background-color: #cccccc; border-radius: 5px; border: none; padding: 5px 8px; cursor: pointer; text-decoration: none" target="_bank">Exportar PDF</a>
	<a class="btn no-print" style="background-color: #cccccc; border-radius: 5px; border: none; padding: 5px 8px; cursor: pointer; text-decoration: none" href="desistimiento_word.php?id=<?php echo $id; ?>" target="_blank">Word</a>
    <?php  
    ...
    <table class="sin-borde">
        <tr>
        	<td style="width: 190px"><img src="<?php echo _ASSETS."img/".$logo;?>"></td>
    		<td style="text-align: center"><?php 
                ...
                if ($haylogo>0) {
                	...
                	?>
					<img src="<?php echo _RUTA."archivo/condominio/documento/";?><?php echo $id_con; ?>/<?php echo $nombre_doc_con; ?>" width="190" style="margin-right: 190px">	
