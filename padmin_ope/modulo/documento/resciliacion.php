...
<body>
	...
	<a class="btn no-print" style="background-color: #cccccc; border-radius: 5px; border: none; padding: 5px 8px; cursor: pointer; text-decoration: none" href="resciliacion_word.php?id=<?php echo $id; ?>" target="_blank">Word</a>
    <?php  
    ...
    <table class="sin-borde">
        ...
        <tr>
        	<td colspan="2" style="text-align:center">
        		<br><br><br>
        		<h4><?php echo utf8_encode($nombre_representante_inmobiliaria);?><br>RUT: <?php echo utf8_encode($rut_representante_inmobiliaria);?><br>pp. Inmobiliaria COSTANERA PACIFICO S.P.A</h4>
        	</td>
        </tr>
    </table>
</body>
