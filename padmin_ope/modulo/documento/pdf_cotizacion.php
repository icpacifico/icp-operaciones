...
<body>';
	...
	<table class="sin-borde">
	    <tr>
			<td colspan="3" style="text-align: left"><img height="165" src="../../assets/img/logoicp.jpg"> 
			</td>
	    </tr>
	    <tr>
	...
	<table class="caja-borde ancho-completo" style="margin-top: 20px">
		...
		<tr>
			...
			if ($id_con == 8) {
				$html .= ' <td class="td-borde-right">-1</td>';
			} else{
				$html .= ' <td class="td-borde-right"> 1</td>';
			}
			$html .= '
			...
			if ($id_con == 6 || $id_con == 7 || $id_con == 8) {
				$html .= ' <td class="td-borde-right text-right">0,00</td>';
			} else{
				$html .= ' <td class="td-borde-right text-right">3,9</td>';
			}
			$html .= '

			<td class="td-borde-right text-right"> 0,00</td>';
	...
	$credito = -$credito_cot;
	$numero_pago = 12 * 15;
	//$interes1 = $interes_cotizacion;
	$interes1 = 4.5;
	$uf_cot = $uf_cotizacion;
	
	$valor_uf_15 = PMT($interes1 / 1200, $numero_pago, $credito);
	...
	$valor_uf_20 = PMT($interes2 / 1200, $numero_pago, $credito);
	...
	$valor_uf_25 = PMT($interes3 / 1200, $numero_pago, $credito);
	...
	$valor_uf_30 = PMT($interes4 / 1200, $numero_pago, $credito);
	...
	<table class="caja-borde ancho-completo" style="margin-top: 10px">
		...
		<tr>
			...
			<td class="td-borde-right td-min-padding" style="text-align: center">'.number_format($interes1, 2, ',', '.').'</td>
		...
		<tr>
			...
			<td class="td-borde-right td-min-padding" style="text-align: center">'.number_format($interes2, 2, ',', '.').'</td>
		...
		<tr>
			...
			<td class="td-borde-right td-min-padding" style="text-align: center">'.number_format($interes3, 2, ',', '.').'</td>
		...
		<tr>
			...
			<td class="td-borde-right td-min-padding" style="text-align: center">'.number_format($interes4, 2, ',', '.').'</td>
	...
	<table class="caja-borde ancho-completo" style="margin-top: 22px">
		<tr>
			<td class="bold td-borde-right" style="width: 50%; line-height: 1.6rem">
				Atendido por: '.mb_strtoupper($nombre_vendedor).'<br>
