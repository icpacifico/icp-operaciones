...
<body>
	...
	$fila = $conexion->extraer_registro_unico();
	if($fila['valor_uf'] == '') {
		echo "NO HAY UF CARGADA PARA LA FECHA o FALTA INFO CLIENTE";
		exit();
	}
	...
	<table class="sin-borde">
	    <tr>
			<td colspan="3" style="text-align: left"><img height="165" src="<?php echo _ASSETS."img/".$logo."";?>"> 
			</td>
	    </tr>
	    <tr>
	    	<td style="vertical-align: bottom;"><b>Proyecto</b></td>
	    	<td style="vertical-align: bottom;"><b>: <?php echo utf8_encode($nombre_con);?></b></td>
	    	<td rowspan="2" style="width: 30%; padding: 0">
	    		<table class="con-borde ancho-completo min-padding">
	    			<tr>
	    				<td>Cotización N°</td>
	    				<td class="text-right"><?php echo $numero_cot; ?></td>
	    			</tr>
	    			<tr>
	    				<td>Fecha</td>
	    				<td class="text-right"><?php echo $fecha_cotizacion; ?></td>
	    			</tr>
	    			<tr>
	    				<td>Valor U.F. $</td>
	    				<td class="text-right"><?php echo number_format($uf_cotizacion, 2, ',', '.'); ?></td>
	    			</tr>
	    		</table>
	    	</td>
	    </tr>
	    <tr>
	    	...
	    	<td style="vertical-align: top;"><b>: <?php echo utf8_encode($direccion_condominio);?></b></td>
	    </tr>
	</table>
	...
	<table class="caja-borde ancho-completo" style="margin-top: 10px;">
		...
		<tr>
			<td>Dirección</td>
			<td><?php echo utf8_encode($direccion_pro);?></td>
			<td>Teléfono 1</td>
			<td><?php echo utf8_encode($fono_pro);?></td>
		</tr>
		<tr>
			<td>Comuna</td>
			<td><?php echo utf8_encode($nombre_com);?></td>
			<td>Teléfono 2</td>
			<td><?php echo utf8_encode($fono2_pro);?></td>
		</tr>
		<tr>
			<td>Email</td>
			<td><?php echo utf8_encode($correo_pro);?></td>
			<td></td>
			<td></td>
		</tr>
	</table>
	...
	<table class="caja-borde ancho-completo" style="margin-top: 20px">
		...
		<tr>
			...
			<td class="td-borde-right"><?php echo utf8_encode($nombre_viv);?></td>
			<td class="td-borde-right">DEPT/<?php echo $nombre_mod ?> <?php echo $numero_cama_mod ?>D+<?php echo $numero_banio_mod ?>B</td>
			<td class="td-borde-right"><?php echo utf8_encode($id_pis);?></td>
			<td class="td-borde-right"><?php echo utf8_encode($nombre_ori_viv);?></td>
			<td class="td-borde-right text-right"><?php echo utf8_encode($metro_viv_for);?></td>
			<td class="td-borde-right text-right"><?php echo utf8_encode($metro_terraza_viv_for);?></td>
			<td class="td-borde-right text-right"><?php echo utf8_encode($metro_total_viv_for);?></td>
			<td class="td-borde-right text-right"><?php echo $valor_viv_for; ?></td>
			<td class=" text-right"><?php echo number_format($valor_viv_pesos, 0, ',', '.'); ?></td>
		</tr>
		<tr>
			<td class="td-borde-right">Bodega</td>
			<td class="td-borde-right"><?php echo utf8_encode($nombre_bod);?></td>
			...
			<td class="td-borde-right text-right">3,9</td>
			<td class="td-borde-right text-right"><?php echo $valor_bodega_for;?></td>
			<td class=" text-right"><?php echo number_format($valor_bodega_pesos, 0, ',', '.'); ?></td>
		</tr>
		<tr>
			<td class="td-borde-right borde-bottom">Estacionamiento</td>
			<td class="td-borde-right borde-bottom"><?php echo utf8_encode($nombre_esta);?></td>
			...
			<td class="td-borde-right borde-bottom text-right">0,00</td>
			<td class="td-borde-right borde-bottom text-right">0,00</td>
			<td class="td-borde-right borde-bottom text-right"><?php echo $valor_esta_for;?></td>
			<td class="borde-bottom text-right"><?php echo number_format($valor_esta_pesos, 0, ',', '.'); ?></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="td-borde bold text-right"><?php echo number_format($precio_lista_uf_total, 2, ',', '.'); ?></td>
			<td class="td-borde bold text-right"><?php echo number_format($precio_lista_pesos_total, 0, ',', '.'); ?></td>
		</tr>
		<tr>
			<td colspan="5"></td>
			<td class="td-borde bold text-right" colspan="3">Descuento</td>
			<td class="td-borde text-right"><?php echo number_format($valor_descuento, 2, ',', '.'); ?></td>
			<td class="td-borde text-right"><?php echo number_format($valor_descuento_pesos, 0, ',', '.'); ?></td>
		</tr>
		<tr>
			<td colspan="5"></td>
			<td class="td-borde bold text-right" colspan="3">Total Precio Venta</td>
			<td class="td-borde bold text-right"><?php echo number_format($precio_con_descuento, 2, ',', '.'); ?></td>
			<td class="td-borde bold text-right"><?php echo number_format($precio_con_descuento_pesos, 0, ',', '.'); ?></td>
		</tr>
	</table>
	...
	<table class="caja-borde ancho-completo" style="margin-top: 10px">
		...
		<tr>
			...
			<td class="td-borde-right text-center"><?php echo number_format($porcentaje_reserva, 2, ',', '.'); ?>%</td>
			<td class="td-borde-right text-right"><?php echo number_format($uf_reserva, 2, ',', '.'); ?></td>
			<td class=" text-right"><?php echo number_format($reserva_pesos, 0, ',', '.'); ?></td>
		</tr>
		<tr>
			<td class="td-borde-right">PIE CONTADO</td>
			<td class="td-borde-right text-center"><?php echo number_format($porcentaje_contado, 2, ',', '.'); ?>%</td>
			<td class="td-borde-right text-right"><?php echo number_format($monto_contado_uf, 2, ',', '.'); ?></td>
			<td class=" text-right"><?php echo number_format($monto_contado_pesos, 0, ',', '.'); ?></td>
		</tr>
		<tr>
			<td class="td-borde-right borde-bottom">CREDITO HIPOTECARIO</td>
			<td class="td-borde-right borde-bottom text-center"><?php echo $porcentaje_credito_cot_for ?>%</td>
			<td class="td-borde-right borde-bottom text-right"><?php echo number_format($monto_credito_uf, 2, ',', '.'); ?></td>
			<td class=" borde-bottom text-right"><?php echo number_format($monto_credito_pesos, 0, ',', '.'); ?></td>
		</tr>
		<tr>
			...
			<td class="td-borde-right borde-bottom text-right"><?php echo number_format($precio_con_descuento, 2, ',', '.'); ?></td>
			<td class=" borde-bottom text-right"><?php echo number_format($precio_con_descuento_pesos, 0, ',', '.'); ?></td>
		</tr>
		<tr>
	...
	$valor_uf_15 = PMT($interes15 / 1200, $numero_pago, $credito);
	$valor_uf_15_round = round($valor_uf_15, 2);
	$valor_uf_15_formato = $valor_uf_15_round;
	...
	$valor_uf_20 = PMT($interes20 / 1200, $numero_pago, $credito);
	$valor_uf_20_round = round($valor_uf_20, 2);
	$valor_uf_20_formato = $valor_uf_20_round;
	...
	$valor_uf_25 = PMT($interes25 / 1200, $numero_pago, $credito);
	$valor_uf_25_round = round($valor_uf_25, 2);
	$valor_uf_25_formato = $valor_uf_25_round;
	...
	$valor_uf_30 = PMT($interes30 / 1200, $numero_pago, $credito);
	$valor_uf_30_round = round($valor_uf_30, 2);
	$valor_uf_30_formato = $valor_uf_30_round;
	...
	<table class="caja-borde ancho-completo" style="margin-top: 10px">
		...
		<tr>
			...
			<td class="td-borde-right td-min-padding" style="text-align: center"><?php echo number_format($interes15, 2, ',', '.'); ?></td>
			<td class="td-borde-right td-min-padding text-right"><?php echo $valor_uf_15_formato; ?></td>
			<td class="td-borde-right td-min-padding text-right"><?php echo $valor_peso_15_formato; ?></td>
			<td class="td-borde-right td-min-padding text-right"><?php echo $valor_peso_15_formato_renta; ?></td>
		</tr>
		<tr>
			<td class="td-borde-right td-min-padding" style="text-align: center">20</td>
			<td class="td-borde-right td-min-padding" style="text-align: center"><?php echo number_format($interes20, 2, ',', '.'); ?></td>
			<td class="td-borde-right td-min-padding text-right"><?php echo $valor_uf_20_formato; ?></td>
			<td class="td-borde-right td-min-padding text-right"><?php echo $valor_peso_20_formato; ?></td>
			<td class="td-borde-right td-min-padding text-right"><?php echo $valor_peso_20_formato_renta; ?></td>
		</tr>
		<tr>
			<td class="td-borde-right td-min-padding" style="text-align: center">25</td>
			<td class="td-borde-right td-min-padding" style="text-align: center"><?php echo number_format($interes25, 2, ',', '.'); ?></td>
			<td class="td-borde-right td-min-padding text-right"><?php echo $valor_uf_25_formato; ?></td>
			<td class="td-borde-right td-min-padding text-right"><?php echo $valor_peso_25_formato; ?></td>
			<td class="td-borde-right td-min-padding text-right"><?php echo $valor_peso_25_formato_renta; ?></td>
		</tr>
		<tr>
			<td class="td-borde-right td-min-padding" style="text-align: center">30</td>
			<td class="td-borde-right td-min-padding" style="text-align: center"><?php echo number_format($interes30, 2, ',', '.'); ?></td>
			<td class="td-borde-right td-min-padding text-right"><?php echo $valor_uf_30_formato; ?></td>
			<td class="td-borde-right td-min-padding text-right"><?php echo $valor_peso_30_formato; ?></td>
			<td class="td-borde-right td-min-padding text-right"><?php echo $valor_peso_30_formato_renta; ?></td>
		</tr>
	</table>
	...
	<table class="caja-borde ancho-completo" style="margin-top: 22px">
		<tr>
			<td class="bold td-borde-right" style="width: 50%; line-height: 1.6rem">
				Atendido por: <?php echo mb_strtoupper($nombre_vendedor); ?><br>
				Celular: <?php echo utf8_encode($fono_vend);?><br>
				Email: <?php echo utf8_encode($correo_vend);?>
			</td>
