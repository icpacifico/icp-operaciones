...
<body>
	<a class="btn no-print" href="entrega_abono_word.php?id=<?php echo $id; ?>" target="_blank">Word</a>
	<?php  
	...
	<table class="sin-borde">
	    ...
	    <tr>
	    	<td>
	    		...
	    		<table style="width: 80%; line-height: 22px">
	    			<tr>
				...
				<table style="width: 90%; border-collapse: collapse;" class="conborde centro">
					<tr class="bold">
						<td>Banco</td>
						<td>Forma de Pago</td>
						<td>N° Doc</td>
