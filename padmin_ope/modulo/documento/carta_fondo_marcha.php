	...
	<table class="sin-borde">
	    ...
	    <tr>
	    	<td>
				...
				<p style="text-align: justify;">Junto con saludar, le hago presente según cierre de negocios y promesa de compraventa firmada por usted, antes de recepcionar su nuevo departamento y según ley N° 19.537 de Copropiedad Inmobiliaria referida en Reglamento de Copropiedad Ud. debe cancelar por concepto de “Fondo de puesta en Marcha” un valor de <b>$ <?php echo $total_prorrateo_depto; ?></b></p>
