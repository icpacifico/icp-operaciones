...
$html .= '
<h3 style="text-align: center">PROMESA DE COMPRAVENTA<br><u>'.strtoupper(utf8_encode($nombre_con)).'</u></h3>
<br>
...
$mpdf->SetHTMLHeader('<table width="100%">
    <tr>
        <td width="50%"><img src="../../assets/img/logoicp.jpg" width="103"></td>
