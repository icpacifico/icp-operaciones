	    ...
	    <tr>
	    	<td>
	    		...
	    		<div style="text-align: justify; line-height: 20px">
					...
					<b><u>DÉCIMO TERCERO: De la entrega material de la cosa que se promete vender.</u></b> La entrega material de la cosa prometida se hará a la Promitente Vendedora al momento de otorgarse la escritura de Compraventa Definitiva, en forma simbólica, en la forma prevista en el artículo seiscientos ochenta y cuatro número uno del Código Civil, permitiéndole la promitente vendedora a la promitente compradora, la aprehensión material de la cosa vendida. Asimismo, la Promitente Vendedora, comunica en este acto y mediante este instrumento a la Promitente Compradora que el departamento que se vende, se estima que estará terminado el <b>primer trimestre del año dos mil veintitrés</b>, debiendo estar a esa fecha los saldos de precio debidamente cancelados.
					<b><u>DÉCIMO CUARTO: De los Gastos.</u></b> Los gastos, impuestos e inscripciones originados por el otorgamiento tanto de esta Promesa de Compraventa, así como los que deriven del contrato de Compraventa Prometido, serán de cargo del Promitente Comprador.
