...
$nombre = 'despacho_promesa'.$id.'-'.date('d-m-Y');
	...
	<table class="sin-borde">
	    ...
	    <tr>
	    	<td>
				...
				<u>Presente</u></p>
				<p>Junto con saludar, <b>Inmobiliaria Cordillera S.P.A</b>, tiene el agrado de hacerle llegar Promesa y Seguro de venta en verde de Compra Venta de departamento reservado en Condominio <?php echo utf8_encode($nombre_con);?>  – La Serena, debidamente protocolizada  ante Notario <?php echo utf8_encode($nombre_notario);?>.</p>
