                    ...
                    <div class="col-sm-5">
                      <!-- general form elements -->
                        <div class="box box-primary">
                            ...
                            <form id="formulario" method="POST" action="update_roles.php" role="form" enctype="multipart/form-data">
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-sm-5"> 
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label for="archivo">Archivo de roles para vivienda y bodega</label>
                                ...
                                <div class="box-footer" id="contenedor_boton">
                                    <button type="submit" class="btn btn-primary pull-left">Procesar archivo csv</button>
                                </div>
                            </form>
                        </div>
                      <!-- /.box -->
